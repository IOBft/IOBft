...
namespace ETModel
{
    ...
    public class Block
    {
        ...
        public Dictionary<int,Transfer> linkstran = new Dictionary<int,Transfer>();   // 包含的交易
    ...
    public static class Helper
    {
        ...
        static public Block GetHeader(this Block This)
        {
            ...
            blk.linkstran = new Dictionary<int, Transfer>(This.linkstran.Count);
        ...
        static public bool AddTransfer(this Block This, int ii,Transfer transfer)
        {
