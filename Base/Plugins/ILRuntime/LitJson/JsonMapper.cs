...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        private static void AddObjectMetadata (Type type)
        {
            ...
            AddTypeProperties(type, data);
        }

        private static void AddTypeProperties (Type type, ObjectMetadata data)
        {
            // yuxj 添加基类成员变量
            if ( type.BaseType != null && type.BaseType.Name != type.Name)
                AddTypeProperties(type.BaseType, data);
            ...
            foreach (PropertyInfo p_info in type.GetProperties())
            {
                ...
                if(!data.Properties.TryGetValue(p_info.Name, out value))
            ...
            foreach (FieldInfo f_info in type.GetFields())
            {
                ...
                if (!data.Properties.TryGetValue(f_info.Name, out value))
